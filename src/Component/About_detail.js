...
import ab_1 from '../assest/about.jpg'
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex flex-column">
                        <img class="img-fluid w-75 align-self-end" src={ab_1} alt=""/>
                        <div class="w-50 bg-content p-5" style={{marginTop: '-25%'}}>
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <p class="d-inline-block bg-content text-primary py-1 px-4">About Us</p>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <h3 class="text-uppercase mb-3">Since 2010</h3>
